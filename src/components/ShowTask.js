            ...
            { tasklist.map((todo) => (
                <li key={todo.id}>
                    <p>
                        ...
                        <div
                            class="w-8 h-8 shrink-0 rounded-lg bg-white border-2 border-stone-500 transition-all duration-300 ease-in-out peer-checked:bg-gradient-to-br from-stone-600 to-stone-400 
                        ...
                        ></div>
                        <span class="mx-3 text-lg font-medium text-gray-900 inline-block whitespace-normal break-all">{todo.name}</span>
                        </label>
                        <span className="time mt-4 ml-">{todo.time}</span>
                    </p>
